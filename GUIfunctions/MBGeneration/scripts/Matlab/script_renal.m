...
P.path_to_streams='C:\Users\bheiles\Documents\Github\microbubble-flow-simulator-gui\GUIfunctions\MBGeneration\example_data\renal\';% path to the csv files containing the streamlines
P.path_to_streamsCells=[P.path_to_streams,'StreamsAsCells\'];% path where you want to save the cell containing streamlines
P.path_to_simulation='C:\Users\bheiles\Documents\Github\microbubble-flow-simulator-gui\GUIfunctions\MBGeneration\example_data\renal\Matlab\';% path where you want to save the simulated positions
...
P.NStreamlineFile=4;% Number of files containing streamlines to be taken (size(dir([P.path_to_streams,'StreamsAsCells\*.mat']),1))
P.NStreamlinePerFile=2;% Max number of streamline to be taken from each file this would mean more microbubble per indi
...
%% Select the streamlines subset from which you want to simulate the MBs on and save them in a file (est time : 1 s)
...
%% Create frames from streams (est time: 334 s)
...
listframes=dir([P.path_to_simulation,'\MBframes_22_07_22_16_32\*.mat']);
